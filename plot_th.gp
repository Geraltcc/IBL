...
set output 'data/theta_plot.png'
...
plot 'data/theta.dat' using 1:2 with points pt 7 ps 0.5 lc rgb 'blue' title 'present', \
     'data/BL2.dat' every ::1 using 2:6 with lines lw 2 lc rgb 'red' title 'xfoil'